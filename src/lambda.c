/*------------------------------------------------------------------------------
* lambda.c : lambda/mlambda integer least square estimation
*
*          Copyright (C) 2007 by T.TAKASU, All rights reserved.
*
* reference :
*
* [1] P.J.G.Teunissen, The least-square ambiguity decorrelation adjustment: a
*     method for fast GPS ambiguity estimation, J.Geodesy, Vol.70, 65-82, 1995
* [2] X.-W.Chang, X.Yang, T.Zhou, MLAMBDA: A modified LAMBDA method for integer
*     least-squares estimation, J.Geodesy, Vol.79, 552-565, 2005
*
* version : $Revision: 1.4 $ $Date: 2007/01/15 05:08:19 $
* history : 2007/01/13 1.0 new
*-----------------------------------------------------------------------------*/
#include "rtklib.h"

static const char rcsid[]="$Id: lambda.c,v 1.4 2007/01/15 05:08:19 TTAKA Exp $";

/* constants/macros ----------------------------------------------------------*/

#define LOOPMAX     2000000          /* maximum count of search loop */
